...
echo <<<_END
  <form action="csaddcourse.php" method="post"><pre>
    ...
    Course Prerequisite         <input type="text" name="course_prerequisite">
    Course Prerequisite Link    <input type="text" name="course_prerequisite_link">
