...
<body>
    <header>
        ...
        <h5>2020 Available Courses</h5>
        <h6><a style="color:white;float:right" href="index.php">HOME</a></h6>
    </header><br>
    <h5><a style="color:#154734;float:right" href="csc002.php">Sort By Class</a></h5><br>
    <table>
        <tr>
            <th>TERM</th>
            <th>CLASS SECTION</th>
        ...
        $sql = "SELECT `TERM`, `CLASS SECTION`, `CLASS TITLE`, `INSTRUCTORS`, `SCHEDULE` FROM `cscourse`";
